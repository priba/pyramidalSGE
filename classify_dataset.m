...
for i = 1:ntrain
    [graphs_train(i).v,graphs_train(i).vl,graphs_train(i).e,...
        graphs_train(i).el] = read_grec_gxl(fullfile(folder, fns_train{i})) ;
end;

for i = 1:nvalid
    [graphs_valid(i).v,graphs_valid(i).vl,graphs_valid(i).e,...
        graphs_valid(i).el] = read_grec_gxl(fullfile(folder, fns_valid{i})) ;
end;

for i = 1:ntest
    [graphs_test(i).v,graphs_test(i).vl,graphs_test(i).e,...
