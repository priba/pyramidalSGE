...
%     folder = '/home/adutta/Workspace/Datasets/GWHistoGraphs' ;
    ...
    for i = 1:ntrain
        [graphs_train(i).v, graphs_train(i).nl.values, graphs_train(i).e,...
            graphs_train(i).el.values] = read_gw_gxl(fullfile(folder, sfolder, subset, fns_train{i})) ;
